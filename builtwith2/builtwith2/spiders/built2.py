...
class BuiltSpider(scrapy.Spider):
    ...
    start_urls = ['https://www.bargainw.com/wholesale/1082/Wholesale-Products.html?sort=&size=24&page=1&sortBy=']
    ...
    def parse(self,response):
        ...
        for product in product_link:
            ...
            yield scrapy.Request(url = product_url,callback=self.parse_item_2)
